-- =============================================================================
-- Quiz4Win — Reinstall generate_game_from_template to copy requires_host
-- Migration: 20260617010100_generate_game_copies_requires_host.sql
-- Author:    A-01 — 2026-06-17
-- =============================================================================
-- Copies game_templates.requires_host into each generated game so automated /
-- AI-presented templates (requires_host = FALSE) never surface in the host-app
-- "available" list. All other logic is preserved verbatim from 20260617000100.
...
BEGIN
    ...
    INSERT INTO public.games (
        ...
        host_assignment_status, requires_host,
        created_at
    ) VALUES (
        ...
        v_assignment_status, v_tpl.requires_host,
        NOW()
    );
