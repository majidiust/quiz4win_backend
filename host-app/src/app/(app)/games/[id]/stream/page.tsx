...
interface Game { id: string; title: string; scheduled_at: string | null; status: string; host_id?: string | null; livekit_room_name?: string | null; run_mode?: string | null; prize_pool?: number | null; questions_count?: number | null; }
