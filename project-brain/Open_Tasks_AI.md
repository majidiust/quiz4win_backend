...
- [P2] [IN_PROGRESS] [A-01] **Host Platform — Phase 7: Notifications, files, audit** — Files DONE; audit DONE; notification side-effects on host events (apply, approve, invite, earning approve) is follow-up.
- [P1] [IN_PROGRESS] [A-01] **Host Platform — Phase 8: `host-app/` Next.js mobile-first frontend** — Scaffold DONE (Next.js 15 + Tailwind 4 + Dockerfile + docker-compose + nginx). 16-screen UI is follow-up work.
- [P1] [IN_PROGRESS] [A-01] **Host Platform — Phase 9: Admin panel host management pages** — `/hosts` list DONE; detail/action UI is follow-up work.
